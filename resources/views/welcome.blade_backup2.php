    ...
    <section id="hotels" class="wow fadeInUp">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <h2><strong>Modul Gratis untuk 1000 pendaftar</strong></h2>
        ...
        <div class="row">
         <div class="col-lg-4 col-md-6">
            <h3><a href="#">Keunggulan 1</a></h3>
              ...
              <p>Peserta berlatih dengan temponya sendiri. Mereka mulai dengan memahami hal-hal yang belum mereka mengerti, lalu mempercepat pembelajaran.</p>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <h3><a href="#">Keunggulan 2</a></h3>
              ...
              <p>Disusun oleh para pakar, perpustakaan latihan, dan praktik yang tepercaya di BisnisKita meliputi matematika, sains, dan lainnya. Selalu gratis untuk siswa dan guru.</p>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <h3><a href="#">Keunggulan 3</a></h3>
              ...
              <p>Bersama BisnisKita, guru dapat mengidentifikasi hal-hal yang belum dimengerti siswa mereka, menyesuaikan instruksi, dan memenuhi kebutuhan setiap siswa.</p>
          </div>
